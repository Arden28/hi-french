      ...
      <div class="max-w-screen-xl px-4 mx-auto">
        ...
        <nav class="mb-3 text-gray-500 text-md" aria-label="Breadcrumb">
          <ol class="inline-flex p-0 space-x-1 list-none md:space-x-1">
            ...
            <li>
              <div class="flex items-center">
                <a href="{{ route('home') }}" class="hover:text-blue-600">Shop</a>
                <svg class="w-4 h-4 mx-2" fill="currentColor" viewBox="0 0 20 20"><path d="M6 6l6 6-6 6"/></svg>
              </div>
            </li>
            <li aria-current="page" class="font-medium text-gray-700 active">Shopping Cart</li>
          </ol>
        </nav>
        <h1 class="text-4xl font-extrabold text-gray-900 lg:text-5xl">Checkout</h1>
        ...
        <div class="mt-6 sm:mt-8 lg:flex lg:items-start lg:gap-12 xl:gap-16">
            <div class="flex-1 min-w-0 space-y-8">
                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <div>
                    <label for="your_name" class="block mb-2 text-sm font-medium text-gray-900"> Your name </label>
                    ...
                    <div>
                    <label for="your_email" class="block mb-2 text-sm font-medium text-gray-900"> Your email* </label>
                    ...
                    <div class="flex items-center gap-2 mb-2">
                        <label for="select-country-input-3" class="block text-sm font-medium text-gray-900"> Country* </label>
                    </div>
                    <select id="select-country-input-3" class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500">
                    ...
                    <div>
                    <div class="flex items-center gap-2 mb-2">
                        <label for="select-city-input-3" class="block text-sm font-medium text-gray-900"> City* </label>
                    </div>
                    <select id="select-city-input-3" class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500">
                    ...
                    <div>
                    <label for="phone-input-3" class="block mb-2 text-sm font-medium text-gray-900"> Phone Number* </label>
                    <div class="flex items-center">
                        ...
                        <svg fill="none" aria-hidden="true" class="w-4 h-4 me-2" viewBox="0 0 20 15">
                        ...
                        <div id="dropdown-phone-3" class="z-10 hidden w-56 bg-white divide-y divide-gray-100 rounded-lg shadow">
                        <ul class="p-2 text-sm font-medium text-gray-700" aria-labelledby="dropdown-phone-button-2">
                            <li>
                            <button type="button" class="inline-flex w-full px-3 py-2 text-sm text-gray-500 rounded-md hover:bg-gray-100 hover:text-gray-900" role="menuitem">
                            ...
                            <button type="button" class="inline-flex w-full px-3 py-2 text-sm text-gray-500 rounded-md hover:bg-gray-100 hover:text-gray-900" role="menuitem">
                                <span class="inline-flex items-center">
                                <svg class="w-4 h-4 me-2" fill="none" viewBox="0 0 20 15" xmlns="http://www.w3.org/2000/svg">
                                    <rect width="19.6" height="14" y=".5" fill="#fff" rx="2" />
                                    <mask id="a" style="mask-type:luminance" width="20" height="15" x="0" y="0" maskUnits="userSpaceOnUse">
                                    <rect width="19.6" height="14" y=".5" fill="#fff" rx="2" />
                                    </mask>
                    ...
                    <input type="email" id="email" class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500" placeholder="name@flowbite.com" required />
                    </div>

                    <div>
                    <label for="company_name" class="block mb-2 text-sm font-medium text-gray-900"> Company name </label>
                    <input type="text" id="company_name" class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500" placeholder="Flowbite LLC" required />
                    </div>

                    <div>
                    <label for="vat_number" class="block mb-2 text-sm font-medium text-gray-900"> VAT number </label>
                    <input type="text" id="vat_number" class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500" placeholder="DE42313253" required />
                    </div>
                ...
                <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
                    ...
                    <div class="flex items-start">
                        ...
                        <input id="credit-card" aria-describedby="credit-card-text" type="radio" name="payment-method" value="" class="w-4 h-4 bg-white border-gray-300 text-primary-600 focus:ring-2 focus:ring-primary-600" checked />
                        </div>
                    ...
                    <div class="flex items-start">
                        <div class="flex items-center h-5">
                        <input id="pay-on-delivery" aria-describedby="pay-on-delivery-text" type="radio" name="payment-method" value="" class="w-4 h-4 bg-white border-gray-300 text-primary-600 focus:ring-2 focus:ring-primary-600" />
                        </div>

                        <div class="text-sm ms-4">
                        <label for="pay-on-delivery" class="font-medium leading-none text-gray-900"> Payment on delivery </label>
                        <p id="pay-on-delivery-text" class="mt-1 text-xs font-normal text-gray-500">+ KES15 payment processing fee</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start">
                        <div class="flex items-center h-5">
                        <input id="paypal-2" aria-describedby="paypal-text" type="radio" name="payment-method" value="" class="w-4 h-4 bg-white border-gray-300 text-primary-600 focus:ring-2 focus:ring-primary-600" />
                        </div>
                ...
                <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
                    ...
                    <div class="flex items-start">
                        <div class="flex items-center h-5">
                        <input id="dhl" aria-describedby="dhl-text" type="radio" name="delivery-method" value="" class="w-4 h-4 bg-white border-gray-300 text-primary-600 focus:ring-2 focus:ring-primary-600" checked />
                        </div>

                        <div class="text-sm ms-4">
                        <label for="dhl" class="font-medium leading-none text-gray-900">  KES15 - DHL Fast Delivery </label>
                    ...
                    <div class="flex items-start">
                        <div class="flex items-center h-5">
                        <input id="fedex" aria-describedby="fedex-text" type="radio" name="delivery-method" value="" class="w-4 h-4 bg-white border-gray-300 text-primary-600 focus:ring-2 focus:ring-primary-600" />
                        </div>
                    ...
                    <div class="flex items-start">
                        <div class="flex items-center h-5">
                        <input id="express" aria-describedby="express-text" type="radio" name="delivery-method" value="" class="w-4 h-4 bg-white border-gray-300 text-primary-600 focus:ring-2 focus:ring-primary-600" />
                        </div>

                        <div class="text-sm ms-4">
                        <label for="express" class="font-medium leading-none text-gray-900">  KES49 - Express Delivery </label>
                ...
                <div>
                <label for="voucher" class="block mb-2 text-sm font-medium text-gray-900"> Enter a gift card, voucher or promotional code </label>
            ...
            <div class="w-full mt-6 space-y-6 sm:mt-8 lg:mt-0 lg:max-w-xs xl:max-w-md">
                ...
                <div class="-my-3 divide-y divide-gray-200">
                    ...
                    <dd class="text-base font-medium text-gray-900"> KES{{ number_format($cartTotal ?? 0) }}</dd>
                    </dl>
                    ...
                    <dl class="flex items-center justify-between gap-4 py-3">
                        @php
                            $tax = ($cartTotal * 16)/100;
                            $total = $cartTotal + $tax;
                        @endphp
                        <dt class="text-base font-normal text-gray-500">Tax</dt>
                        <dd class="text-base font-medium text-gray-900"> KES{{ number_format($tax) }}</dd>
                    </dl>

                    <dl class="flex items-center justify-between gap-4 py-3">
                    <dt class="text-base font-bold text-gray-900">Total</dt>
                    <dd class="text-base font-bold text-gray-900"> KES{{ number_format($total ?? 0) }}</dd>
                    </dl>
                </div>
                </div>

                <div class="flex items-start sm:items-center">
                    <input id="terms-checkbox-2" type="checkbox" value="" class="w-4 h-4 bg-gray-100 border-gray-300 rounded text-primary-600 focus:ring-2 focus:ring-primary-500" />
                    <label for="terms-checkbox-2" class="text-sm font-medium text-gray-900 ms-2">
                        I agree with the <a href="#" title="" class="underline text-primary-700 hover:no-underline">
                        Terms and Conditions</a> of use of <strong>Hi! French</strong>
                    </label>
                </div>

                <div class="space-y-3">
                <a href="#" type="submit" class="flex w-full items-center justify-center rounded-lg bg-primary-700 px-5 py-2.5 text-sm font-medium text-white hover:bg-primary-800 focus:outline-none focus:ring-4  focus:ring-primary-300">Proceed to Payment</a>

                {{-- <p class="text-sm font-normal text-gray-500">One or more items in your cart require an account. <a href="#" title="" class="font-medium underline text-primary-700 hover:no-underline">Sign in or create an account now.</a>.</p> --}}
                </div>
            </div>
        </div>
    </form>
