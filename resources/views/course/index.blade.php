      ...
      <div class="max-w-screen-xl px-4 mx-auto">
        ...
        <nav class="mb-3 text-gray-500 text-md" aria-label="Breadcrumb">
          <ol class="inline-flex p-0 space-x-1 list-none md:space-x-1">
            ...
            <li aria-current="page" class="font-medium text-gray-700 active">Courses</li>
          </ol>
        </nav>
        <h1 class="text-4xl font-extrabold text-gray-900 lg:text-5xl">Our Courses</h1>
        <p class="max-w-2xl mt-2 text-lg text-gray-600">Master the French language with expert-led lessons, structured paths, and practical content for all levels.</p>
    ...
    <section class="py-12 bg-white">
      <div class="grid max-w-screen-xl gap-10 px-4 mx-auto lg:grid-cols-12">
            ...
            <article class="p-6 mb-4 bg-white border border-gray-200 rounded-lg shadow-md">
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-4">
                        <img class="rounded-full w-7 h-7" src="{{ asset('assets/images/user.jpg') }}" alt="{{ $course->author->name ?? 'Author' }}" />
                ...
                <div class="flex items-center justify-between gap-4 mt-4">
                    <p class="text-xl font-extrabold leading-tight text-gray-900">KSh {{ number_format($course->price) }}</p>
        ...
        <div class="p-6 border border-blue-200 shadow-sm bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl">
            <h3 class="mb-2 text-xl font-bold text-gray-900">Join Our French Speaking Club</h3>
            <p class="mb-4 text-sm leading-relaxed text-gray-600">Get weekly practice prompts, engaging topics, and connect with fellow learners in real conversations.</p>
            <a href="#" class="w-full py-2.5 px-3 bg-blue-600 text-white text-sm font-medium rounded-lg hover:bg-blue-700 transition">Join Now</a>
        </div>
        </aside>
